...
and ID token verification against the tenant's JWKS. Mirrors
backend/app/auth/oidc.py exactly — this service's own PingOne app, own
discovery/JWKS caches (deliberately not shared across services, same as
